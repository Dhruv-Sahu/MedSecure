    ...
    if (props.MyNFT) {
        return (
            <>
                ...
                <div className="single__nft__card" style={{width:"80%"}}>
                    ...
                    <div className="nft__content" style={{width
                    :"80%"}}>
                        <h5 className="nft__title">
                            <Link to={`/viewNFT/${cid?.cid}`}>{hospitalName}</Link>
                        </h5>

                        <div className="creator__info-wrapper d-flex gap-3" style={{width:"80%"}}>
                            <div className="creator__info w-100 d-flex align-items-center justify-content-between" style={{width:"80%"}}>
                                <div>
