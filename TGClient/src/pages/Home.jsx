        ...
        (!showComponent && (
          ...
          >
            <div class="mine1" style={{width:"420px"}}>
              <div className="part1" style={{
                ...
                <p style={{ marginBottom: "0px" }}><span style={{
                  backgroundImage: "linear-gradient(90deg, #2666BA, #00337C)",
                  fontWeight: "700",
                  fontSize: "20px",
                  backgroundSize: "100%",
                ...
                <p style={{ marginBottom: "0px" }}><span style={{
                  ...
                  MozTextFillColor: "transparent",
                  paddingLeft: "20px"
                }}>Aadhar Number:</span> {aadharNumber}</p>
                  </div>
              <div className="single__nft__card1" style={{borderRadius:"25px",marginTop:"25px",boxShadow: "rgba(0, 0, 0, 0.1) 0px 4px 12px"}}>
                <p style={{
                  backgroundImage: "linear-gradient(90deg, #2666BA, #00337C)",
                  fontWeight: "700",
                  fontSize: "30px",
          ...
          <div className=" mt-3 d-flex align-items-center justify-content-between">
            ...
            <div className="part2" style={{ flex: "8" }}>
              <div
                class="container"
                style={{ display: "flex", flexDirection: "row", paddingLeft: "25px",justifyContent:"space-between" }}
              >
                ...
                <div class="part4" style={{ flex: "1" }}>
                  <div
                    class="part1_2"
                    style={{ flex: "1", boxShadow: "rgba(0, 0, 0, 0.1) 0px 4px 12px", }}
                  >
                    <h2>Revenue</h2>
                    <p>50$</p>
                  </div>
              ...
              {userData.userType === "Seller" ? (
                ...
                ><div className="div"style={{display:"flex",flexWrap:"wrap",flexDirection:"column",height:"80%"}}>
                  <div class="mygraph1"
                    style={{
                      flex: "1",
                      display:"block",
