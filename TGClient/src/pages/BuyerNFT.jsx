  ...
  return (
    ...
    alignItems: "center"}}>
              <div className="single_nft_content">
                ...
                <h5>Patient is suffering from Cancer,Dengue.Patient went to Srm Hospital and has last updated his report on 23/03/23.The next visit to the hospital will be on 30/03/23.</h5>
              </div>
            </Col>
          </Row>
        </Container>
